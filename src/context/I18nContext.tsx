...
const dict = {
  en: {
    ...
    "hero.tagline": "Ancient Wisdom. Modern Healing.",
    "hero.subtitle": "Experience intelligent healthcare powered by AI — book trusted doctors, consult by video, and receive instant prescriptions. All in one breath.",
